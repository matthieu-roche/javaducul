...
{
   JOptionPane.showMessageDialog(null, "Creer votre aquarium avec vos poissons \n" + "Regardez les évoluer!\n" + "Qui sera le grand gagnant?\n", "Règles du jeu",
...
//            
            ...
            JOptionPane.showMessageDialog(null, "L'une de vos entrées n'est pas un nombre !\n" + "Pensez à mettre 0 au lieu d'une case vide. \n" + "Verifiez bien qu'il n'y a pas d'espace après le nombre. " , "Attention !",
